...
function NewCssCal(startDateTime, endDateTime, pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode)
{
...
{
	if(id == 'startEventDate' )
	{
	startDateTime.content = date;
    }else if(id == 'endEventDate')
    {
	  endDateTime.content = date;  //
	}
	document.getElementById(id).innerText = date.Year+"-"+date.Month+"-"+date.Day+" "+date.Hrs+":"+date.Mins+":00";
	if(id == 'endEventDate'){
		if(document.getElementById('startEventDate').innerText == 'start'){
			var startEventDate = "";
		}else
		{
		...
		callPHP(document.getElementById('startEventDate').innerText,document.getElementById('endEventDate').innerText);
	}
	else if(id == 'startEventDate' && document.getElementById('endEventDate').innerText.length > 10){
	     callPHP(document.getElementById('startEventDate').innerText,document.getElementById('endEventDate').innerText);
	}
